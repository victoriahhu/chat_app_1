...
import '../models/personal_care_model.dart';
            ...
            children: <Widget>[
              ...
              Container(
                ...
                child: PageView(
                  ...
                  children: List.generate(
                    entertainmentRecommendations.length,
                        (int index) => GestureDetector(
                      onTap: () {
                        Navigator.of(context).push(MaterialPageRoute(
                            builder: (context) => SelectedEntertainmentScreen(
                                entertainModel: entertainmentRecommendations[index])));
                      },
                      child: Container(
                        ...
                        decoration: BoxDecoration(
                          ...
                          image: DecorationImage(
                            ...
                            image: CachedNetworkImageProvider(
                                entertainmentRecommendations[index].image),
                          ),
                        ),
                        child: Stack(
                          children: <Widget>[
                              ...
                              child: ClipRRect(
                                ...
                                child: BackdropFilter(
                                  ...
                                  child: Container(
                                      ...
                                      child:
                                      Text(
                                        entertainmentRecommendations[index].name,
                                        style: GoogleFonts.lato(
              ...
              Padding(
                ...
                child: SmoothPageIndicator(
                  controller: _pageController,
                  count: entertainmentRecommendations.length,
              ...
              Container(
                ...
                child: PageView(
                  ...
                  scrollDirection: Axis.horizontal,
                  children: List.generate(
                    careRecommendations.length,
                        (int index) => GestureDetector(
                      onTap: () {
                        Navigator.of(context).push(MaterialPageRoute(
                            builder: (context) => SelectedPersonalCareScreen(
                                careModel: careRecommendations[index])));
                      },
                      child: Container(
                        margin: EdgeInsets.only(right: 28.8),
                        width: 333.6,
                        ...
                        decoration: BoxDecoration(
                          ...
                          image: DecorationImage(
                            fit: BoxFit.cover,
                            image: CachedNetworkImageProvider(
                                careRecommendations[index].image),
                          ),
                        ),
                        child: Stack(
                          children: <Widget>[
                              ...
                              child: ClipRRect(
                                ...
                                child: BackdropFilter(
                                  ...
                                  child: Container(
                                      ...
                                      child:
                                      Text(
                                        careRecommendations[index].name,
                                        style: GoogleFonts.lato(
                                            fontWeight: FontWeight.w700,
                                            color: Colors.white,
                                            fontSize: 16.8),
              ...
              Padding(
                ...
                child: SmoothPageIndicator(
                  controller: _pageController,
                  count: careRecommendations.length,
                  effect: ExpandingDotsEffect(
                      activeDotColor: Color(0xFF8a8a8a),
                      dotColor: Color(0xFFababab),
                      dotHeight: 4.8,
